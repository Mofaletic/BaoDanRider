...
#include "BDRPickupZone.generated.h"
...
UCLASS()
class BAODANRIDER_API ABDRPickupZone : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    void ResolvePickup(ABDRRiderPawn* Rider, const FBDROrderData& Order, UPARAM(ref) float& RemainingSeconds, FString& OutMessage);
